...
public class RecordAttentionPdfCopy extends Activity implements OnPageChangeListener,OnLoadCompleteListener{

    private static final String TG2 = RecordAttentionPdfCopy.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.attention_record_pdf_view_2);

        pdfView= (PDFView)findViewById(R.id.pdfView);

        Button btn = (Button) findViewById(R.id.cpdf);

        ll = (LinearLayout) findViewById(R.id.llep);
            ...
            public void onClick(View arg0) {
                ...
                if (tgStreamReader != null) {
                    ...
                    try {
                        ...
                        setContentView(R.layout.attention_graph_2);
                        ...
                        double avg = (double)sum/(double)(atVal.size());

                        at_mn.setText(Double.toString(avg));
...
//    }
    ...
    public void showToast(final String msg,final int timeStyle){
        RecordAttentionPdfCopy.this.runOnUiThread(new Runnable()
        {
            public void run()
            {
    ...
    private void setUpDeviceListView(){
        ...
        selectDialog.setOnCancelListener(new OnCancelListener(){
            ...
            public void onCancel(DialogInterface arg0) {
                ...
                RecordAttentionPdfCopy.this.unregisterReceiver(mReceiver);
            }
